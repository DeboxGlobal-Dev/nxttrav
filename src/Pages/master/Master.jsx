      ...
      <Layout>
        <div className="master container-fluid">
          <div className="row px-2 py-4 bg-light mb-4">
                    ...
                    <div className="row">
                      ...
                      <div className="col-7 p-0 ml-2">
                        ...
                        <NavLink to="/master/sightseeing">
                          <div className="master-list-icon">
                            <img
                              src="/assets/icons/binocular.png"
                              alt="image"
                            />
                            <span
                              className={`pl-1 ${
                      ...
                      <div className="col-7 p-0 ml-2">
                        ...
                        <NavLink to="/master/tourescortprice">
                          <div className="master-list-icon">
                            ...
                            <span
                              className={`pl-1 ${
                                "tourescortpricemaster".includes(
                                  search?.toLowerCase()?.replace(/\s/g, "")
                                ) && search !== ""
                                  ? "bg-primary pr-1"
                                  : ""
                    ...
                    <div className="row">
                      ...
                      <div className="col-7 p-0 ml-2">
                        <NavLink to="/master/visatype">
                          <div className="mb-lg-2 mb-xl-2 mb-md-1 mb-1 master-list-icon">
                            <img
                              src="assets/icons/boarding-pass.png"
                              alt="image"
                            />
                            <span
                              className={`pl-1 ${
                    ...
                    <div className="row">
                      ...
                      <div className="col-7 p-0 ml-2">
                        <NavLink to="/master/passporttype">
                          <div className="mb-lg-2 mb-xl-2 mb-md-1 mb-1 master-list-icon">
                            <img
                              src="/assets/icons/passport5.png"
                              alt="image"
                            />
                            <span
                              className={`pl-1 ${
                        ...
                        <NavLink to="/master/passportcost">
                          <div className="master-list-icon">
                            <img
                              src="/assets/icons/passport7.png"
                              alt="image"
                            />
                            <span
                              className={`pl-1 ${
                    ...
                    <div className="row">
                      ...
                      <div className="col-7 p-0 ml-2">
                        ...
                        <NavLink to="/master/airline">
                          <div className="master-list-icon">
                            <img
                              src="/assets/icons/travelling.png"
                              alt="image"
                            />
                            <span
                              className={`pl-1 ${
                    ...
                    <div className="row">
                      ...
                      <div className="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6 my-2 my-md-2 my-lg-0 my-xl-0 p-0 px-2">
                        <NavLink to="/master/itenararyoverview">
                          <div className="mb-lg-2 mb-xl-2 mb-md-1 mb-1 master-list-icon">
                            <img
                              src="/assets/icons/itinerary2.png"
                              alt="image"
                            />
                            <span
                              className={`pl-1 ${
            ...
            {/* Guide Tour Manager Master Menu List */}
            <div className="card w-100 shadow-none border">
              <div className="card-body p-2 ">
                <p className="text-primary fw-500 m-0 mb-1 d-block master-head">
                  Guide & Tour Manager
