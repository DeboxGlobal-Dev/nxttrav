...
import { marketTypeInitialValue, marketTypeValidationSchema } from "./MasterValidations";
          ...
          <div className="card shadow-none border">
            ...
            >
              <div className="col-xl-10 d-flex align-items-center">
                <h5 className="card-title d-none d-sm-block">Market Type</h5>
              </div>
